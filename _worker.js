...
let userID = '2e7b26c6-f477-48c3-8c31-35a9d12f72d8';
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'MyVPS Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'MyVPS Frag - Best Ping 💥';
...
const updateDataset = async (env, Settings) => {
    ...
    const proxySettings = {
        ...
        localDNS: Settings?.get('localDNS') || '9.9.9.9',
...
const renderHomePage = async (request, env, hostName, fragConfigs) => {
	...
	<head>
        ...
        <title>MyVPS ${panelVersion}</title>
	...
	<body>
		<h1>MyVPS <span style="font-size: smaller;">${panelVersion}</h1>
    ...
    <body>
        <div id="error-container">
            ...
            <div id="error-message">
                <h2>${message} ${refer 
                    ? 'Please try again or refer to <a href="">documents</a>' 
                    : ''}
                </h2>
